...
// Import app icons
import pumpfunIcon from './assets/iphone icons/pons.png'
          ...
          >
            {!showMessages ? (
              <>
                ...
                {!showComments && (
                  <div className="dock">
                    <a href="https://pump.fun/coin/4wcZdpFLdSGPKGnTaRfVpNdXfUVSV9pc1Ez8sevEpump" target="_blank" rel="noopener noreferrer" className="dock-app">
